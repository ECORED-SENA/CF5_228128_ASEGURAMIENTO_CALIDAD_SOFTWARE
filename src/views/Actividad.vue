  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Tecnologías del desarrollo web
        p.mb-4 Afianzar algunos de los conceptos más importantes asociados a la identificación de tecnologías del desarrollo #[i web].
